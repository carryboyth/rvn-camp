...
const campervans = [
  {
    ...
    price: "$3,500",
    description: "4 seats with bathroom and kitchen",
  },
  {
    id: 2,
    ...
    price: "$4,200",
    description: "6 seats, bathroom, kitchen, and solar system",
  },
  {
    id: 3,
    ...
    price: "$2,800",
    description: "2 seats with small kitchen",
  },
  {
    id: 4,
    ...
    price: "$3,800",
    description: "4 seats with bathroom and TV",
  },
];
  ...
  return (
    <section className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <p className="text-muted-foreground text-center mb-12">Popular Motorhome Rentals</p>
