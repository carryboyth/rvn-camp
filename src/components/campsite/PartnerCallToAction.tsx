...
const PartnerCallToAction = () => {
  return (
    <div className="mt-16 mb-8">
      <Card className="bg-gradient-to-r from-green-600 to-green-700 text-white rounded-2xl border-0 shadow-2xl overflow-hidden">
        <CardContent className="p-8 md:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <Button 
                size="lg" 
                className="bg-white text-green-600 hover:bg-green-50 font-semibold px-8 py-3 rounded-xl h-auto"
              >
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <img
                  src="/lovable-uploads/1c68e1b4-9fe2-4968-a384-030737e07ca5.png"
                  alt="Partner Success"
